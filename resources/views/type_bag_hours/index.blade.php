    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="hour_price" class="form-control" placeholder="{{ __('message.enter')." ".__('message.hour_price') }}" value="@if(session('type_bag_hour_price') != '%'){{str_replace(".", ",", session('type_bag_hour_price'))}}@endif">
            </div>
        </div>
    </div>
    <div class="row">
...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <td>{{ str_replace(".", ",", $value->hour_price) }}€</td>
